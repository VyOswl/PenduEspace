$(document).ready(function() {
	...
	let 
		...
		listeMots = ["astronaute","univers","cosmonaute","interstellaire","espace-temps","planete","gravitation","comete","navette spatial","soleil","neptune","saturne","jupiter","pluton","orbite","venus","uranus","mercure","lune","etoile","satellite","exoplanete","galaxie","meteorite","poussiere","nebuleuse","astronome","astre","mars","tellurien","asteroide","heliocentrisme","relativite","extra-terrestre","atmosphere","telescope","ciel","celeste","pesanteur","trajectoire","geocentrisme","champ magnetique","systeme solaire","voie lactee","eclispe","fusee","constellation","astrolabe","gravite","orbite","station","apesanteur","comete","trou noir","petite ours","grande ours"],
		leMot = "",
		motTrouver = [],
		motEssaye = "",
		nbFaux = 0,
	...
	function affichageCanvas(){
		...
		if(perdu){
			...
			annonce(leMot,50,27,"bold 35px monospace","white");
			updtPointPerdu();
			setTimeout(jeuTermine,3000);
		}else{
		annonce(motEssaye,50,27,"bold 35px monospace","white");
		}
		annonce("Tu as trouvé "+recPointGagne()+" mots.",120,350,"bold 20px monospace","white");
		annonce("Tu n'as pas trouvé "+recPointPerdu()+" mots.",120,380,"bold 20px monospace","grey");
	}
